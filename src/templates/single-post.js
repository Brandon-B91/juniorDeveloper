...
const SinglePost = ({ data, pageContext }) => {
    ...
    const baseUrl = 'https://gatsbytutorial.com.uk'
            ...
            <Card>
                ...
                <CardBody>
                    <CardSubtitle>
                        ...
                        <ul className="post-tags">                            {post.tags.map(tag => (
                                <li key={tag}>
             ...
             <h3 className="text-center">
               ...
               <div className="text-center social-share-links">
                      <ul>
                          <li><a href={"https://www.facebook.com/sharer.php?u="
                          + baseUrl 
                          + pageContext.slug} 
                          className="facebook" 
                          target="_blank" 
                          rel="noopener norefferer">
                            <i className="fab fa-facebook-f fa-2x">
                             ...
                             <li><a href={"https://www.twitter.com/share?url=" +
